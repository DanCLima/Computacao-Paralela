...
1º Faça um programa com a estrutura mester/worker, onde:

 - mester: gera uma quantidade aleatória entre 1000 e 2000 números de valores aleatórios entre 0 e 99, e envia para cada worker.
 
 - worker: recebe os valores gerados pelo mester, calcula a somatória dos valores e devolve para o mester.
